...
/// <summary>A debug view shows you what happens inside the physics engine. You can view bodies, joints, fixtures and more.</summary>
public class DebugView : DebugViewBase, IDisposable
{
    ...
    private readonly StringBuilder _debugPanelSbUpdate = new StringBuilder();

    //Performance graph
    private bool _updatePerformanceGraphCalled;
