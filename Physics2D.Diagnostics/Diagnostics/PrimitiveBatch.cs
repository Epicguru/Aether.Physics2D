...
public class PrimitiveBatch : IPrimitiveBatch, IDisposable
{
    ...
    /// <summary>Begin is called to tell the PrimitiveBatch what kind of primitives will be drawn, and to prepare the graphics card to render those primitives.</summary>
    ...
    /// <summary>End is called once all the primitives have been drawn using AddVertex. it will call Flush to actually submit the draw call to the graphics card, and then tell the basic effect to end.</summary>
    public void End()
    {
        if (!_hasBegun)
        {
