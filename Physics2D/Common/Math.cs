...
public static class MathUtils
{
    ...
    /// <summary>Return the angle between two vectors on a plane The angle is from vector 1 to vector 2, positive anticlockwise The result is between -pi -> pi</summary>
...
public struct Mat22
{
    ...
    /// <summary>Solve A * x = b, where b is a column vector. This is more efficient than computing the inverse in one-shot cases.</summary>
...
public struct Mat33
{
    ...
    /// <summary>Solve A * x = b, where b is a column vector. This is more efficient than computing the inverse in one-shot cases. Solve only the upper 2-by-2 matrix equation.</summary>
    /// <param name="b">The b.</param>
    /// <returns></returns>
...
/// <summary>A transform contains translation and rotation. It is used to represent the position and orientation of rigid frames.</summary>
public struct Transform
{
    ...
    /// <summary>Initialize using a position vector and a Complex rotation.</summary>
    ...
    /// <summary>Initialize using a position vector and a rotation.</summary>
    /// <param name="position">The position.</param>
...
/// <summary>This describes the motion of a body/shape for TOI computation. Shapes are defined with respect to the body origin, which may no coincide with the center of mass. However, to support dynamics we must interpolate the center of mass position.</summary>
public struct Sweep
{
