...
/// <summary>Serialize the world into an XML file</summary>
public static class WorldSerializer
{
    /// <summary>Serialize the world to a stream in XML format</summary>
    ...
    /// <summary>Deserialize the world from a stream XML</summary>
    /// <param name="stream"></param>
