...
public static class YuPengClipper
{
    ...
    /// <returns>A list of closed polygons, which make up the result of the clipping operation. Outer contours are ordered counter clockwise, holes are ordered clockwise.</returns>
    ...
    /// <summary>Calculates the characteristics function for all edges of the given simplical chains and builds the result chain.</summary>
    /// <remarks>Used by method <c>Execute()</c>.</remarks>
