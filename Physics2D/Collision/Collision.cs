...
{
    /// <summary>The ray extends from p1 to p1 + maxFraction * (p2 - p1). If you supply a max fraction of 1, the ray extends from p1 to p2. A max fraction of 0.5 makes the ray go from p1 and half way to p2.</summary>
...
{
    /// <summary>The ray hits at p1 + fraction * (p2 - p1), where p1 and p2 come from RayCastInput. Contains the actual fraction of the ray where it has the intersection point.</summary>
...
public struct AABB
{
    ...
    private readonly Vertices vertices = new Vertices(4) {default, default, default, default};
    ...
    /// <summary>Determines whether the AAABB contains the specified point.</summary>
    ...
    /// <summary>Raycast against this AABB using the specificed points and maxfraction (found in input)</summary>
...
public static class Collision
{
    ...
    /// <summary>Find the separation between poly1 and poly2 for a give edge normal on poly1.</summary>
    ...
    private static class EPCollider
    {
        ...
        /// <summary>This holds polygon B expressed in frame A.</summary>
