...
/// <summary>A shape is used for collision detection. You can create a shape however you like. Shapes used for simulation in World are created automatically when a Fixture is created. Shapes may encapsulate a one or more child shapes.</summary>
public abstract class Shape
{
    ...
    /// <summary>Contains the properties of the shape such as: - Area of the shape - Centroid - Inertia - Mass</summary>
    ...
    /// <summary>Compute the mass properties of this shape using its dimensions and density. The inertia tensor is computed about the local origin, not the centroid.</summary>
    protected abstract void ComputeProperties();

    /// <summary>Used for the buoyancy controller</summary>
