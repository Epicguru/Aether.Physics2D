...
/// <summary>A chain shape is a free form sequence of line segments. The chain has two-sided collision, so you can use inside and outside collision. Therefore, you may use any winding order. Connectivity information is used to create smooth collisions. WARNING: The chain will not collide properly if there are self-intersections.</summary>
public class ChainShape : Shape
{
    ...
    /// <summary>Constructor for ChainShape. By default have 0 in density.</summary>
    public ChainShape()
        : base(0)
    {
    ...
    /// <summary>This method has been optimized to reduce garbage.</summary>
