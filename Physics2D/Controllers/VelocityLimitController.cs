...
/// <summary>Put a limit on the linear (translation - the movespeed) and angular (rotation) velocity of bodies added to this controller.</summary>
public class VelocityLimitController : Controller
{
    ...
    /// <summary>Initializes a new instance of the <see cref="VelocityLimitController" /> class. Sets the max linear velocity to Settings.MaxTranslation Sets the max angular velocity to Settings.MaxRotation</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="VelocityLimitController" /> class. Pass in 0 or float.MaxValue to disable the limit. maxAngularVelocity = 0 will disable the angular velocity limit.</summary>
