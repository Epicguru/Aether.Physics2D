...
/// <summary>A contact edge is used to connect bodies and contacts together in a contact graph where each body is a node and each contact is an edge. A contact edge belongs to a doubly linked list maintained in each attached body. Each contact has two contact nodes, one for each attached body.</summary>
...
/// <summary>The class manages contact between two shapes. A contact exists for each overlapping AABB in the broad-phase (except if filtered). Therefore a contact object may exist that has no contact points.</summary>
public class Contact
{
    ...
    /// <summary>Get the next contact in the world's contact list.</summary>
    /// <value>The next.</value>
    public Contact Next { get; internal set; }

    /// <summary>Get the previous contact in the world's contact list.</summary>
    /// <value>The prev.</value>
    public Contact Prev { get; internal set; }

    /// <summary>Determines whether this contact is touching.</summary>
    /// <returns><c>true</c> if this instance is touching; otherwise, <c>false</c>.</returns>
    ...
    /// <summary>Update the contact manifold and touching status. Note: do not assume the fixture AABBs are overlapping or are valid.</summary>
